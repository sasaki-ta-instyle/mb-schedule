...
export const metadata: Metadata = {
  ...
  icons: {
    icon: `${SITE_URL}/mb_favicon_2026.png`,
    apple: `${SITE_URL}/mb_favicon_2026.png`,
  },
  openGraph: {
    type: "website",
    ...
    title: TITLE,
    description: DESCRIPTION,
    images: [{ url: `${PROD_SITE_URL}/mb_ogp_2026.png`, width: 1200, height: 630 }],
  },
  twitter: {
    card: "summary_large_image",
    title: TITLE,
    description: DESCRIPTION,
    images: [`${PROD_SITE_URL}/mb_ogp_2026.png`],
  },
};
